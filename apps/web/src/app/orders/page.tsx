        ...
        <div className="mt-6 space-y-4">
          {orders.map((order) => (
            <Link
              ...
              className="flex items-center justify-between rounded-xl border border-gray-100 bg-white p-5 shadow-sm transition hover:border-brand-teal-200 hover:shadow-md"
            >
              <div>
