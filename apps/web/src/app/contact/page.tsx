    ...
    <div>
      ...
      <div className="bg-gradient-to-br from-brand-blue-50 via-white to-brand-orange-50 border-b border-gray-100 py-12">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-4 inline-flex items-center gap-2 rounded-full bg-brand-orange-50 border border-brand-orange-200 px-4 py-2 text-sm font-medium text-brand-orange-700">
          ...
          {contactInfo.map((item) => (
            ...
            >
              <div className="flex items-start gap-3">
                <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-lg bg-brand-orange-50">
