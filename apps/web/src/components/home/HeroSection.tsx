...
export default function HeroSection() {
  return (
    <section className="relative overflow-hidden bg-gradient-to-br from-brand-yellow-50 via-white to-brand-blue-50">
      <div className="mx-auto max-w-7xl px-4 py-24 sm:px-6 sm:py-32 lg:px-8">
        <div className="max-w-2xl">
          <h1 className="font-heading text-4xl font-bold tracking-tight text-brand-blue-900 sm:text-5xl lg:text-6xl">
            ...
            <span className="text-brand-yellow-500">Solutions</span>
          </h1>
