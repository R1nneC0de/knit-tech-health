...
export default function MultiDivisionHero() {
  return (
    <section className="relative overflow-hidden bg-gradient-to-br from-brand-blue-50 via-white to-brand-teal-50">
      <div className="mx-auto max-w-7xl px-4 py-24 sm:px-6 sm:py-32 lg:px-8">
        <div className="max-w-3xl">
          ...
          <h1 className="mt-4 font-heading text-4xl font-bold tracking-tight text-brand-blue-900 sm:text-5xl lg:text-6xl">
            Premium Healthcare &{' '}
            <span className="text-brand-teal-500">Technology Solutions</span>
          </h1>
